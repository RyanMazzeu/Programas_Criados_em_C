...
void confereletra(float a,float b,float c,float d,float e){
    float media = 127;
    if(a<=media&&b>media&&c>media&&d>media&&e>media){
        printf("A\n");
    }
    else if(b<=media&&a>media&&c>media&&d>media&&e>media){
        printf("B\n");
    }
    else if(c<=media&&a>media&&b>media&&d>media&&e>media){
        printf("C\n");
    }
    else if(d<=media&&a>media&&c>media&&b>=media&&e>media){
        printf("D\n");
    }
    else if(e<=media&&a>media&&c>media&&d>media&&b>media){
        printf("E\n");
    }else
    {
        printf("*\n");
